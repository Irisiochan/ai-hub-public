import type { ContactRow, Db } from '../platform/index.js';
import { isSystemReceipt, stripQuotedLines } from '../memory/index.js';
import { contactConfig } from '../contacts/index.js';
import { historicalMessageText } from '../messages/index.js';
...
/** Defense in depth：机器派单身份不许参与生活事件。 */
