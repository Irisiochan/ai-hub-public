...
import { COORDINATION_SWEEP_SOURCE } from './triage-shared.mjs';
...
// Canonical formal source lives in triage-shared (cycle-free for triage-core).
export const COORDINATION_SOURCE = COORDINATION_SWEEP_SOURCE;
