...
/**
 * Formal sweep source. Only events enqueued by scanCoordinationIfDue carry
 * this source with a coordination/verification payload mode. Webhook or timer
 * events that forge the mode without this source are non-essential and must
 * be suppressed in workflowOnly (R2 forged-mode hole).
 */
export const COORDINATION_SWEEP_SOURCE = 'coordination-sweep';
