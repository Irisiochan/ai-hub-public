...
export default function ContactList({ contacts, statuses, unread, selectedId, user, onSelect, onAdd, onUserClick, onWorkers, onPublishStatus }: Props) {
  return (
    <aside className="contact-list">
      <header className="contact-list-header">
        <h1>ai-hub</h1>
        <span className="header-btns">
          <button className="add-btn publish-btn" title="发布状态" onClick={onPublishStatus}>↻</button>
