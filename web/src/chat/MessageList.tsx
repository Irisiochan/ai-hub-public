...
import { type Contact, type ContactStatus, type Message, type UserProfile, type WorkerJob } from '../platform/api';
...
import type { FollowupJobInput } from './sideJobReceipts';
import JobThread from '../jobs/JobThread';
